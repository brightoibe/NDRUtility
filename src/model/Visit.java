...
public class Visit {
    ...
    private model.datapump.Demographics demo;
    ...
    public static String codeServicesReceived(HashMap<Integer, Obs> map, String drugName) {
        String service = "";
        String value = "";
        ...
        Obs obs=map.get(7778203);
        
        if (StringUtils.isNotBlank(drugName)  && (drugName.toUpperCase().contains("COTRI") || drugName.toUpperCase().contains("CTX") || obs!=null)) {
            service += "Rcvd_CTX ";
        }
    ...
    public static String[] toArray(Visit visit) {//, ) {
        ...
        model.datapump.Demographics demo = visit.getDemo();
        ...
        String regimenName="";
        String code="";
        obs=visit.getConceptMap().get(7778108);
        if(obs!=null){
            code=String.valueOf(RegimenCoder.getCode(obs.getVariableValue()));
        }else{
            obs=visit.getConceptMap().get(7778109);
            if(obs!=null){
                code=String.valueOf(RegimenCoder.getCode(obs.getVariableValue()));
            }else{
                code="";
        ...
        if(obs!=null){
            statusCode=obs.getValueCoded();
        }
      
        if(statusCode==1259){
            artStatus="PMTCT";
        }else if(statusCode==7778362){
            artStatus="OPEP";
        }else if(statusCode==7778361){
            artStatus="NOPEP";
        }else if(statusCode==7778550){
            artStatus="HEI";
        }else if(visit.getArtStartDate()!=null && visit.getArtStartDate().compareTo(visit.getVisitDate())<0){
            artStatus="ART";
       ...
       /* if (obs != null) {
        ...
        if (!code.isEmpty() && !lastARTPickupDate.isEmpty()) {
            dataList.add(14, formatDate2(visit.getVisitDate()));
        }else{
            dataList.add(14, "");
        }
       
        dataList.add(15, codeServicesReceived(visit.getConceptMap(), visit.getDrugName()));
        ...
        if (visit.getDrugName()!=null && visit.getDrugName().toUpperCase().contains("CTX")) {
            dataList.add(22, formatDate2(visit.getVisitDate()));
            dataList.add(23, "1");
        } else {
            dataList.add(22, "");
            dataList.add(23, "");
        ...
        obs=visit.getConceptMap().get(315);
        if(obs!=null){
            dataList.add(31,obs.getVariableValue());
        }else{
            dataList.add(31, "");
        }
        dataList.add(32, getFormNameString(visit));
        obs=visit.getConceptMap().get(7778111);
        ...
        if (obs != null) {
            dataList.add(35, obs.getVariableValue());
        } else {
            dataList.add(35, "");
        }
        dataList.add(36, transID);
        dataList.add(37, firstFormDate);
        dataList.add(38, lastVisitDate);
        //if (regimen != null) {
            dataList.add(39, visit.getDrugName());
            // dataList.add(43,regimen.getRegimenName());
       // } else {
           // dataList.add(38, "");
        //
        dataList.add(40, lastARTPickupDate);
        dataList.add(41, formatDate2(demo.getPmtctEnrollmentDt()));
        dataList.add(42, formatDate2(demo.getHeiEnrollmentDt()));
        obs = visit.getConceptMap().get(7778108);
        if(obs!=null){
            dataList.add(43,obs.getVariableValue());
        }else{
            obs = visit.getConceptMap().get(7778109);
            if(obs!=null){
                dataList.add(43,obs.getVariableValue());
        ...
        //dataList.add(42,formatDate2(demo.getHeiEnrollmentDt()));
       // String formNames=getFormNameString(visit);
    ...
    public static Visit createVisit(model.datapump.Demographics demo, Date visitDate, HashMap<Integer, Obs> map,  Date artStartDate,String drugName, Date firstFormDate, Date lastVisitDate, Date lastARTPickupDate) {
        Visit visit = new Visit();
        visit.setDemo(demo);
        visit.setPatientID(demo.getPatientID());
        visit.setVisitDate(visitDate);
        visit.setConceptMap(map);
        visit.setDrugName(drugName);
   ...
   // }
     ...
     * @return the demo
     */
    public model.datapump.Demographics getDemo() {
        return demo;
    }
     ...
     */
    public void setDemo(model.datapump.Demographics demo) {
        this.demo = demo;
    }
